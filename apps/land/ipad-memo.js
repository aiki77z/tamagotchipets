...
const STORAGE_KEYS = {
  selectedPet: "landMemoSelectedPet",
  deskEnabled: "landMemoDeskEnabled",
  names: "landMemoPetNames",
  memos: "landMemoPetMemos",
  memoPages: "landMemoPetPages"
};

const DEFAULT_MEMOS = ["\u526a\u89c6\u9891", "\u559d\u6c34", "\u6574\u7406\u7d20\u6750", "\u65e9\u70b9\u4f11\u606f"];
const DEFAULT_PET_ID = pets.some((pet) => pet.id === "elizardotchi") ? "elizardotchi" : pets[0]?.id || "";
