...
const APP_DISPLAY_NAME = "Tamagotchi Land Pets";
const STATE_SCHEMA_VERSION = 3;
const PET_SCALE_LIMITS = { min: 0.35, max: 1 };
const PET_ASPECT_RATIO = 384 / 416;
const DEFAULT_PET_SCALE = 0.6;
const PET_OPTIONS = [
  { id: "elizardotchi", label: "蜥蜴吉" },
  { id: "furawatchi", label: "芙朵吉" },
  { id: "gumax", label: "叉叉熊" },
  { id: "hebitchi", label: "蛇蛇吉" },
  { id: "mametchi", label: "麻美吉" },
  { id: "meowtchi", label: "猫猫吉" },
  { id: "mimitchi", label: "咪咪吉" },
  { id: "molmotchi", label: "摩尔吉" },
  { id: "pochi", label: "波吉" },
  { id: "potsunentchi", label: "一朵吉" },
  { id: "ratchi", label: "乐乐吉" },
  { id: "reopacchi", label: "守宫吉" },
  { id: "sebiretchi", label: "龙崽吉" },
  { id: "shigemi-san", label: "灌木吉" },
  { id: "shiipucchi", label: "咩咩吉" },
  { id: "tustustchi", label: "刺刺吉" }
];
